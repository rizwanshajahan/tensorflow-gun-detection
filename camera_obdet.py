...
class ipcamCapture:
    def __init__(self, URL):
        ...
        self.capture = cv2.VideoCapture('rtsp://<IP ADDRESS>:8554/test')
                        ...
                        while(True):
                            ...
                            for imgIndex in range(len(partialCap)):
                                ...
                                for od in odList:
                                    ...
                                    print("Weapon Detected: ", clsPrb)
                                    sock.sendto(clsPrb.encode(), (UDP_IP, UDP_PORT))
